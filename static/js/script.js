window.onload = function () {
  ...
  document.getElementById("chat-form").addEventListener("submit", function (event) {
    ...
    fetch('/gpt3', {
      ...
      .then((data) => {
        ...
        document.getElementById("model-answer-btn").classList.remove("hidden");
        document.getElementById("model").classList.remove("hidden");
        document.getElementById("get_suggestion").classList.remove("hidden");
  ...
  resetBtn.addEventListener("click", function () {
    ...
    document.getElementById("model-answer-btn").classList.add("hidden");
    document.getElementById("model").classList.add("hidden");
    document.getElementById("get_suggestion").classList.add("hidden");
